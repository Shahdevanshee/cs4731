...
def importAStar1(classFile):
	if os.path.exists(classFile + "/astarnavigator.pyc"):
		...
		compileall.compile_dir("./Baseline1/")
		sys.path.insert(0, "./Baseline1/")
		astar = imp.load_compiled('astar1_module', "./Baseline1/astarnavigator.pyc")
	return astar
...
def importAStar2(classFile):
	if os.path.exists(classFile + "/astarnavigator.pyc"):
		...
		compileall.compile_dir("./Baseline1/")
		sys.path.insert(0, "./Baseline1/")
		astar = imp.load_compiled('astar2_module', "./Baseline1/astarnavigator.pyc")
	return astar
