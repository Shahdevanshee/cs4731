...
def setUpWorld(playerClass):
	...
	b2 = Base(BASE, (2500, 700), world, 2, BaselineHumanMinion, MyHumanHero, BUILDRATE, SQUADBASEHITPOINTS)
	b2.setNavigator(nav)
	world.addBase(b2)
	...
	t21 = Tower(TOWER, (2400, 550), world, 2, SQUADTOWERHITPOINTS, BIGTOWERFIRERATE, BIGTOWERBULLETRANGE, BigTowerBullet)
	world.addTower(t21)

	t22 = Tower(TOWER, (2400, 850), world, 2, SQUADTOWERHITPOINTS, BIGTOWERFIRERATE, BIGTOWERBULLETRANGE, BigTowerBullet)
	world.addTower(t22)
